...
class WidgetBoxSettingsSheet extends StatefulWidget {
  ...
  final VoidCallback onIconPackPressed;
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                trailing: widget.selectedLanguage == 'id'
              ...
              ListTile(
                ...
                trailing: widget.selectedLanguage == 'en'
                    ? const Icon(Icons.check, color: Color(0xFFD49B9B))
                    : null,
                onTap: () {
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Icon(Icons.dashboard_customize_outlined, color: textColor, size: 24),
              ...
              ListTile(
                ...
                title: Text('Cuaca', style: TextStyle(color: textColor, fontWeight: FontWeight.w500)),
              ...
              ListTile(
                ...
                title: Text('Tampilan jam', style: TextStyle(color: textColor, fontWeight: FontWeight.w500)),
              ...
              ListTile(
                contentPadding: const EdgeInsets.symmetric(horizontal: 24.0),
                leading: Icon(Icons.add_box_outlined, color: iconColor),
                title: Text('Tambahkan sebuah widget kustom', style: TextStyle(color: textColor, fontWeight: FontWeight.w500)),
                trailing: Icon(Icons.chevron_right, color: iconColor),
                onTap: () {},
              ),
              ...
              ListTile(
                ...
                title: Text('Pindahkan widget', style: TextStyle(color: textColor, fontWeight: FontWeight.w500)),
                trailing: Icon(Icons.chevron_right, color: iconColor),
                onTap: () {},
              ),
              ...
              ListTile(
                contentPadding: const EdgeInsets.symmetric(horizontal: 24.0),
                title: Text('Tampilkan media widget', style: TextStyle(color: textColor, fontWeight: FontWeight.w500)),
                subtitle: Text('Disaat memainkan musik', style: TextStyle(color: subColor, fontSize: 13)),
                trailing: Switch.adaptive(
              ...
              ListTile(
                contentPadding: const EdgeInsets.symmetric(horizontal: 24.0),
                title: Text('Tampilkan persentase baterai', style: TextStyle(color: textColor, fontWeight: FontWeight.w500)),
                trailing: Switch.adaptive(
                  value: _showBattery,
                  activeColor: const Color(0xFFD49B9B),
                  onChanged: (val) {
              ...
              ListTile(
                ...
                title: Text('Ubah favorit', style: TextStyle(color: textColor, fontWeight: FontWeight.w500)),
                trailing: Icon(Icons.chevron_right, color: iconColor),
                onTap: () {},
              ),
              ...
              ListTile(
                ...
                title: Text('Pengaturan Box Launcher', style: TextStyle(color: textColor, fontWeight: FontWeight.w500)),
                trailing: Icon(Icons.chevron_right, color: iconColor),
                onTap: () {},
              ),
              ...
              ListTile(
                ...
                title: Text('Box Launcher Pro', style: TextStyle(color: textColor, fontWeight: FontWeight.w500)),
                subtitle: Text('Cobalah untuk 7 hari', style: TextStyle(color: subColor, fontSize: 13)),
                trailing: Icon(Icons.chevron_right, color: iconColor),
                onTap: () {},
              ),
              ...
              ListTile(
                contentPadding: const EdgeInsets.symmetric(horizontal: 24.0),
                leading: Icon(Icons.wallpaper_outlined, color: iconColor),
                title: Text('Ubah Wallpaper', style: TextStyle(color: textColor, fontWeight: FontWeight.w500)),
                subtitle: Text('Ganti latar belakang layar', style: TextStyle(color: subColor, fontSize: 13)),
                trailing: Icon(Icons.chevron_right, color: iconColor),
              ...
              ListTile(
                ...
                title: Text('Pilih Icon Pack', style: TextStyle(color: textColor, fontWeight: FontWeight.w500)),
                subtitle: Text(
                  widget.iconPackName.isNotEmpty ? widget.iconPackName : 'Default System',
                  style: TextStyle(color: subColor, fontSize: 13),
                ),
                trailing: Icon(Icons.chevron_right, color: iconColor),
                onTap: widget.onIconPackPressed,
              ),

              ListTile(
                contentPadding: const EdgeInsets.symmetric(horizontal: 24.0),
                leading: Icon(Icons.language_outlined, color: iconColor),
                title: Text('Pilih Bahasa', style: TextStyle(color: textColor, fontWeight: FontWeight.w500)),
                subtitle: Text(
                  widget.selectedLanguage == 'id' ? 'Bahasa Indonesia' : 'English',
                  style: TextStyle(color: subColor, fontSize: 13),
                ),
                trailing: Icon(Icons.chevron_right, color: iconColor),
                onTap: () {
